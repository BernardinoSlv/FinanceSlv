    ...
    <form action="{{ route('quick-leaves.update', [
        ...
        <div class="row gy-3 mb-4">
            ...
            <div class="col-sm-6">
                ...
                <input type="text" name="title" class="form-control" value="{{ old('title', $quickLeave->title) }}">
                <div class="form-text"></div>
            </div>
            <div class="col-sm-6">
                <label for="" class="form-label">Valor</label>
                <input type="text" name="amount" class="form-control" value="{{ old('amount', $quickLeave->amount) }}">
