...
@section('content')
    ...
    <div class="product-count d-flex align-items-center gap-3 gap-lg-4 mb-4 fw-bold flex-wrap font-text1">
        <a href="{{ route('expenses.index') }}"><span class="me-1">All</span><span
                class="text-secondary">({{ $expenses->total() }})</span></a>
    ...
    <form action="{{ route('expenses.index') }}" method="GET" class="row g-3">
        ...
        <div class="col-auto">
            <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                ...
                <a class="btn btn-primary px-4" href="{{ route('expenses.create') }}"><i
                        ...
                        <tbody>
                            @foreach ($expenses as $expense)
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:;">{{ $expense->identifier->name }}</a>
                                    </td>
                                    <td>{{ $expense->title }}</td>
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('expenses.edit', $expense) }}">Editar</a>
                                                </li>
                                                <li>
