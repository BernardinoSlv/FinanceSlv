        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item active" aria-current="page">Devedores</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="row g-3">
        ...
        <div class="col-auto">
            <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                ...
                <a class="btn btn-primary px-4" href="{{ route('debtors.create') }}"><i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a href="{{ route('debtors.edit', $debtor) }}" class="dropdown-item">
                                                        <i class="bi bi-pencil-square"></i>
                                                        Editar
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('debtors.payments.index', $debtor) }}"
                                                        class="dropdown-item">
