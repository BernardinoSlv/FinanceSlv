        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item active" aria-current="page">Identificadores</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="row g-3">
        ...
        <div class="col-auto">
            <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                ...
                <a class="btn btn-primary px-4" href="{{ route('identifiers.create') }}"><i
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('identifiers.edit', $identifier) }}">Editar</a>
                                                </li>
                                                <li>
                                                    <form action="{{ route('identifiers.destroy', $identifier) }}"
                                                        method="POST">
                                                        @method('DELETE')
                                                        @csrf
