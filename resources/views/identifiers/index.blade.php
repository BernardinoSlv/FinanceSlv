...
<div class="row g-3">
    ...
    <div class="col-auto">
        <div class="d-flex align-items-center gap-2 justify-content-lg-end">
            ...
            <a class="btn btn-primary px-4" href="{{ route('quick-entries.create') }}"><i class="bi bi-plus-lg me-2"></i>Criar</a>
        </div>
    </div>
</div><!--end row-->
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" href="{{ route('identifiers.edit', $identifier) }}">Editar</a>
                                        </li>
                                        <li>
                                            <form action="{{ route('identifiers.destroy', $identifier) }}" method="POST">
                                                @method('DELETE')
                                                @csrf

                                                <button type="submit" class="dropdown-item" onclick="return confirm('Deseja excluir? ')">Remover</button>
                                            </form>
                                        </li>
                                    </ul>
                                </div>
